...
@section('title', 'Edit Product Gallery - ' . $product->title)
@section('content')
                            ...
                            <nav class="breadcrumb-two" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a
                                            href="javascript:void(0);">Edit Product Gallery</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row m-0">
                    <div class="col-12">
                        <form class="mt-3" method="POST"
                            action="{{ route('cms.products.media.update', ['product_id' => $product->id, 'media_id' => $medias->id]) }}"
