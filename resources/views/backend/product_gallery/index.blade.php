                ...
                <div class="widget-header">
                            ...
                            <nav class="breadcrumb-two" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a
                                            href="javascript:void(0);">Product Gallery</a></li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            <a href="{{ route('cms.products.media.create', $products->id) }}" name="txt"
                                    ...
                                    @forelse($medias as $media)
                                        <tr>
                                            ...
                                            <td class="img-on-tab-style ">
                                                @if ($media->filename)
                                                    <img src="{{ asset('storage/images/products/gallery/' . $media->filename) }}"
                                                ...
                                                <div class="dropdown custom-dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.products.media.edit', ['product_id' => $products->id, 'media_id' => $media->id]) }}">Edit
                                                        </a>

                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.products.media.delete', ['product_id' => $products->id, 'media_id' => $media->id]) }}">
                                                            Delete
                                                        </a>
                                                    </div>
                                            </td>
