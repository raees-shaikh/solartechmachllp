                ...
                <div class="widget-header">
                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            <a href="{{ route('cms.product.create') }}" name="txt" class="btn btn-primary mt-2 ml-3 ">
                                Add New Product
                            </a>
                        </div>
                                                ...
                                                <div class="dropdown custom-dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.product.show', $product->id) }}">View</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.product.edit', $product->id) }}">Edit</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.products.media.index', $product->id) }}">View Gallery</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('cms.product.delete', $product->id) }}"
